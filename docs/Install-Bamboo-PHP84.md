...
Composer will pull in all runtime dependencies declared in [`composer.json`](../composer.json) such as FastRoute, Nyholm PSR-7, Guzzle, Predis, Illuminate Database, and Monolog.
